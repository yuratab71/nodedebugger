...
const isProcessRunning = (): boolean => {
    console.log("exitCode: ", !subprocess?.exitCode);
    console.log("is killed: ", !subprocess?.killed);
...
ipcMain.on(TERMINATE_SUBPROCESS, () => {
        ...
        mainWindow.webContents.send(PROCESS_LOG, passMessage("process isnt running");
    };
})
